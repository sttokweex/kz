...
var moneySymbol = 11;
var baseReels = [
    [7, 4, 6, 1, 10, 10, 9, 2, 5, 6, 3, 6, 9, 11, 11, 11, 7, 8, 5, 1, 10, 5, 6, 8, 2, 4, 10],
    [8, 6, 9, 2, 7, 9, 10, 5, 4, 9, 6, 4, 5, 8, 10, 11, 11, 11, 3, 7, 9],
    [9, 2, 4, 3, 5, 8, 11, 11, 11, 7, 4, 5, 8, 10, 8, 6, 2, 7, 5, 2, 1, 3, 10, 8],
    [11, 11, 10, 5, 7, 4, 7, 7, 8, 9, 2, 7, 5, 3, 2, 3, 4, 10, 3, 8, 4, 6, 10, 6, 6, 7],
    [3, 8, 4, 7, 1, 10, 3, 2, 5, 6, 1, 6, 4, 6, 7, 4, 10, 7, 11, 2, 11, 11, 9, 3, 7, 10, 6, 8, 5, 9, 10, 5],
];
var freeReels = [
...
SlotMachine.prototype.BonusSpin = function (player) {
    ...
    if (this.moneyCacheIndex >= this.moneyBonusCacheList.length) {
        ...
        if (moneyCount == 15) {
            this.winMoney = Number(player.betPerLine) * this.lineCount * 1000;
        } else {
            this.winMoney = MoneyWinFromCache(this.moneyCache, Number(player.betPerLine));
        }
