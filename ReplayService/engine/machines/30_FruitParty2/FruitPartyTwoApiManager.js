...
ApiManager.prototype.InitApi = function (player, param) {
    var result = {
        ...
        cfgs: "1",
        counter: "2",
        def_s: "3,4,5,6,7,8,9,8,3,4,5,6,7,8,9,8,3,4,5,6,7,8,9,7,3,4,5,6,7,8,9,5,3,4,5,6,7,8,9,5,3,4,5,6,7,8,9,6,3",
        def_sa: "4,5,6,7,8,9,3",
        def_sb: "4,5,6,7,8,9,3",
        defc: "100.00",
        fsbonus: "",
        gameInfo: `{rtps:{purchase:"96.45",regular:"96.53"},props:{max_rnd_sim:"1",max_rnd_hr:"495050",max_rnd_win:"5000"}}`,
        gmb: "0,0,0",
        index: "1",
        l: "20",
        na: "s",
...
ApiManager.prototype.GameApi = function (player, prevGameMode, param) {
    ...
    if (player.machine.multiLineIndex.length > 0) {
        result["slm_lmi"] = player.machine.multiLineIndex.join();
        result["slm_lmv"] = player.machine.multiLineValues.join();
    }
    if (player.machine.wildTrail.length > 0) {
        result["trail"] = player.machine.wildTrail;
    }
    if (player.machine.wildMake.length > 0) {
        result["stf"] = player.machine.wildMake;
    }
