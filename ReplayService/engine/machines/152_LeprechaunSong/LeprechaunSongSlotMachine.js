...
var fsCountsArr = [10, 15, 3];
var fsMultiArr = [2, 2, 1];
var baseReels = [
...
var freeReels = [
    [
        [4, 10, 2, 11, 5, 10, 9, 6, 8, 11, 7, 7, 8, 3, 10, 9, 5],
        [2, 10, 6, 8, 3, 11, 4, 8, 6, 7, 9, 10, 3, 11, 11, 9, 5, 9, 10],
        [4, 11, 7, 8, 9, 10, 5, 4, 5, 8, 3, 10, 6, 11, 2, 11, 9],
        [6, 8, 4, 8, 11, 7, 7, 11, 5, 9, 6, 11, 10, 3, 11, 9, 10, 8, 7, 2, 9, 7, 10, 10, 9, 8],
        [8, 10, 9, 10, 6, 3, 11, 6, 5, 8, 4, 9, 8, 10, 4, 9, 7, 11, 11, 2, 7, 11, 8, 9, 8, 7, 7]
    ],
    [
        [7, 9, 11, 2, 8, 6, 12, 10, 9, 10, 4, 12, 11, 6, 7, 8, 3, 5, 3, 8, 10],
        [9, 3, 3, 7, 5, 10, 4, 9, 6, 11, 9, 10, 8, 8, 11, 11, 2, 10, 6],
        [3, 11, 10, 12, 10, 6, 9, 4, 8, 11, 10, 9, 2, 7, 4, 5, 5, 8],
        [10, 4, 6, 8, 8, 9, 9, 6, 3, 5, 2, 8, 7, 9, 10, 7, 8, 9, 7, 10, 11, 11, 10, 11, 7, 11],
        [6, 2, 7, 8, 4, 11, 10, 11, 9, 10, 3, 9, 10, 7, 11, 9, 12, 8, 7, 9, 12, 8, 10, 8, 4, 6, 11, 7, 5]
    ],
    [
...
var payTable = [
    ...
    [0, 0, 0, 50, 40, 20, 20, 10, 10, 8, 6, 4, 0],
    [0, 0, 0, 200, 160, 120, 100, 40, 30, 20, 10, 10, 0],
    [0, 0, 0, 400, 300, 250, 220, 200, 200, 150, 100, 100, 0]
]; //0             , 1             , 2             
var payLines = [
    [5, 6, 7, 8, 9],          // 1
    [0, 1, 2, 3, 4],          // 2
...
SlotMachine.prototype.SpinForFreeGen = function (bpl, totalBet, fsWin, isCall = false) {
    ...
    freeSpinCacheList.push(scatterCache);
