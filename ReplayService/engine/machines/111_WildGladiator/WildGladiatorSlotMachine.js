...
var baseReels = [
    [12, 8, 6, 6, 7, 8, 2, 1, 12, 11, 12, 3, 7, 10, 11, 4, 5, 4, 9, 5, 10],
    [7, 10, 5, 10, 8, 2, 6, 4, 6, 11, 9, 3, 8, 12, 11, 9, 11, 7],
    [6, 7, 11, 1, 3, 5, 3, 5, 9, 12, 4, 8, 9, 6, 2, 1, 7, 10, 9],
    [4, 7, 5, 9, 3, 10, 12, 8, 5, 12, 4, 10, 12, 8, 11, 2, 3, 11, 9, 6, 10],
    [5, 12, 2, 12, 12, 8, 11, 10, 8, 3, 11, 6, 7, 9, 1, 9, 4, 8]
];
var payTable = [
...
SlotMachine.prototype.SpinForFreeGen = function (bpl, totalBet, fsWin, isCall = false) {
    ...
    var freeCache = RandomFreeViewCache(baseReels, bpl, fsWin, 10);

    freeSpinCacheList.push(scatterView);

    var pattern = {
        win: scatterView.win + freeCache.win,
