...
ApiManager.prototype.GameApi = function (player, prevGameMode, param) {
    ...
    if (prevGameMode == "BASE") {
        ...
        if (!player.machine.isFreeSpinAdd) {
            ...
            result["accv"] = `0~1~${player.machine.freeSpinLevel}~0`;
        } else {
            result["accm"] = "cp~tp~lvl~sc~cl";
            result["accv"] = `0~1~${player.machine.freeSpinLevel}~${player.machine.wildCount}~${player.machine.freeSpinLevel - player.machine.wildCount}`;
